...
class TestExecute:
    ...
    openai_data = {
        ...
        "input_params": {"prompt": "Please describe the image.", "image_url": "IMAGE_URL"},
        "credentials": {"OPENAI_API_KEY": os.environ.get("OPENAI_API_KEY", None)},
    }
    gemini_data = {
        "bundle_id": "gemini_vision_models",
        "plugin_id": "chat_completion_by_gemini_1_0_pro",
        "input_params": {"prompt": "Please describe this image", "image_url": ""},
        "credentials": {"GOOGLE_GEMINI_API_KEY": os.environ.get("GOOGLE_GEMINI_API_KEY", None)},
    }
