...
function ApiKeys() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    setApiKeysList((prevList) =>
      prevList.filter((item) => record.apikey_id !== item.apikey_id),
    );
    ...
    <div className={styles["api-keys"]}>
      <Spin spinning={tableLoading} wrapperClassName={styles.spinloading}>
        <ModalTable
          ...
          onOpenDrawer={handleNewInstance}
        />
      </Spin>
      <Modal
        title={t("projectEditAPIKey")}
      ...
      >
        ...
        >
          ...
          >
            <Input
              className={styles["edit-instance-modal"]}
      ...
      >
        <Form layout="vertical" className={styles["edit-form"]} form={form}>
          <Form.Item
            label={t("projectModelColumnName")}
            name="name"
            rules={[{ required: true, message: `${t("projectInputName")}` }]}
          >
            <Input
              className={styles["edit-instance-modal"]}
              onChange={handleChangeNameValue}
      ...
      >
        ...
        >
          <Form.Item
            label={t("projectAPIKeyName")}
            name="name"
            rules={[
              { required: true, message: `${t("projectAPIKeyValidate")}` },
            ]}
          >
            <Input
              onChange={handleDeleteValue}
              className={styles["edit-instance-modal"]}
              placeholder={t("projectAPIKeyDeletePlaceholder")}
            ></Input>
          </Form.Item>
        </Form>
      </Modal>
