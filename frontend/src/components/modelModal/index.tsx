...
const ModelModal = react.forwardRef((props: modelModalProps, ref) => {
  ...
  const resourceListOrder = [
    "taskingai_documentation_url",
    "official_site_url",
  ...
  const fetchAiModelsList = async (offset: number, providerId: string) => {
    try {
      ...
      const res: any = await getAiModelsList(
        offset,
        100,
        providerId,
  ...
  return (
    <div>
      <Modal
        ...
        title={
          openModalOne
            ? t("projectModelBaseModelSelection")
            : !props.type
              ? t("projectProviderSelection")
              : props.type === "chat_completion"
                ? "Provider Selection - Chat Completion"
                : "Provider Selection - Text Embedding"
        }
        ...
        className={openModalOne ? "create-model-one" : "create-models"}
      >
        {openModalOne ? (
            ...
            <div className="center">
              <Spin spinning={centerLoading}>
                <div className="inputWithLabel1">
                  <div className="label">
                    {t("projectModelCreateModelSelectBaseModel")}
                  </div>
                </div>
                {promptList.length === 0 ? (
                  <div className="img-model">
                    <NoModel className="img-no-model" />
                  </div>
                ) : (
                  <div className="card-map">
                    {promptList.map((item: promptListType, index: number) => (
                      <div
                        key={index}
                        className={`providermodelcard ${selectedOneId === item.model_schema_id ? "providermodelcardInner1" : ""}`}
                      ...
                      >
                          ...
                          <div className="frameWrapper">
                            <div className="frameDiv">
                              <div className="modelproviderParent">
                                ...
                                <div className="openaigpt4">
                                  {item.model_schema_id}
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="chatCompletionParent">
                          <div className="chatCompletion">
                            {typeReverse[item.type as keyof typeof typeReverse]}
                          </div>
                          <RightArrow />
                        </div>
                      </div>
            ...
            {promptList.length !== 0 && (
              <div className="right">
                ...
                <div className="content">
                  ...
                  <div className="label3" style={{ marginTop: "22px" }}>
                    {t("projectModelColumnType")}
                  </div>
                ...
                <div className="feature">
                  {properties && (
                    <div className="label3" style={{ marginBottom: "8px" }}>
                      {t("projectModelFeatures")}
                    </div>
                  )}
          ...
          <Spin spinning={modelOneLoading}>
            <div className="content">
              <div className="left">
                <div className="title">{t("projectSelectProvider")}</div>
                <div
                  style={{ height: "676px", overflow: "auto" }}
                  ...
                  <div className="content-list">
                    {ModelProviderList.map((item, index) => (
                      <div
                        key={index}
                        onClick={() =>
                          getCenterData(item.provider_id, item.name, item)
                        }
                        className={`openai-card ${item.provider_id === providerId && "select-provider"}`}
                      >
                        ...
                        >
                          ...
                          {!props.type && (
                            <div className="choices">
                              {item.num_model_schemas}{" "}
                              {item.num_model_schemas <= 1
                                ? t("projectModelLow")
                                : t("projectModelLows")}
                            </div>
                          )}
                    ...
                    {resourcesList.map((item: any) => {
                      ...
                      return (
                        <div key={key} className="item">
                          {
                            resourcesType[key as keyof typeof resourcesType]
                              .icon
                          }{" "}
                          <a href={value as string} target="black">
                            {
                              resourcesType[key as keyof typeof resourcesType]
                                .name
                            }
      ...
      <Modal
        ...
        title={t("projectModelCreateModalOneTitle")}
        width={1000}
        centered
        open={modelTwoOpen}
        footer={[
      ...
      >
        <div className="second-modals">
          <div className="base-model" style={{ marginTop: "24px" }}>
            {t("projectModelColumnBaseModel")}
          </div>
          ...
          >
            ...
            >
              <Form.Item
                ...
                label={t("projectModelCreateModelName")}
                name="name"
              >
                <div>
                  <Input
                    className="input-name"
                    placeholder={t("projectModelCreatePlaceholder")}
                  />
                </div>
              </Form.Item>
              {type === "wildcard" && (
          ...
          {type === "wildcard" && (
            <>
              ...
              <div className="credentials">
                {t("projectModelColumnProperties")}
              </div>
              <ConfigProvider
                theme={{
                  components: {
              ...
              >
                ...
                >
                  ...
                  {modelTypes === "text_embedding" && (
                    <>
                      <Form.Item
                        label={t("projectModelEmbeddingSize")}
                        required
                        name="embedding_size"
                        rules={[
                          {
                      ...
                      >
                        <div>
                          <div className="description">
                            {t("projectModelEmbeddingSizeDesc")}
                          </div>
                          <InputNumber
                            style={{ width: "100%" }}
                            parser={(value: any) =>
                            ...
                            placeholder={t(
                              "projectModelEmbeddingSizePlaceholder",
                            )}
                          />
                        </div>
                      </Form.Item>
                      <Form.Item
                        label={t("projectModelInputMaxTokens")}
                        name="input_token_limit"
                      >
                        <div>
                          <div className="description">
                            {t("projectModelInputMaxTokensDesc")}
                          </div>
                          <InputNumber
                            parser={(value: any) =>
                              isNaN(value) ? "" : parseInt(value, 10)
                            ...
                            style={{ width: "100%" }}
                            placeholder={t(
                              "projectModelInputMaxTokensPlaceholder",
                            )}
                          />
                        </div>
                      </Form.Item>
                      <Form.Item label={"Max batch size"} name="max_batch_size">
                        <div>
                          <div className="description">
                            The maximum number of text chunks that a provider's
                            API can process in one call. Default value is 512.
                          </div>
                          <InputNumber
                            parser={(value: any) =>
                              isNaN(value) ? "" : parseInt(value, 10)
                  ...
                  {modelTypes === "chat_completion" && (
                    <>
                      ...
                      <Form.Item
                        label="Output max tokens"
                        name="output_token_limit"
                      >
                        <div>
                          <div className="description">
                            {t("projectModelOutputMaxTokensDesc")}
                          </div>
                          <InputNumber
                            style={{ width: "100%" }}
                            parser={(value: any) =>
                            ...
                            placeholder={t(
                              "projectModelOutputMaxTokensPlaceholder",
                            )}
                          />
                        </div>
                      </Form.Item>
                  ...
                  >
                    <div>
                      ...
                      <InputNumber
                        ...
                        style={{ width: "100%" }}
                        placeholder={t("projectModelInputMaxTokensPlaceholder")}
                      />
                    </div>
                  </Form.Item>
                  <Form.Item
                  ...
                  >
                    <div>
                      ...
                      <InputNumber
                        ...
                        placeholder={t("projectModelEmbeddingSizePlaceholder")}
                      />
                    </div>
                  </Form.Item>
                </Form>
          ...
          <div className="label-desc" style={{ marginBottom: "24px" }}>
            We will send one token to the model provider to verify the validity
            of your credentials. All credentials are encrypted at rest with
            AES-256 and in transit with TLS 1.2.
          </div>
          <Form
            layout="vertical"
            autoComplete="off"
          ...
          >
            {formData.properties &&
              Object.entries(formData.properties).map(([key, property]) => (
                <Form.Item
                  key={key}
                  name={key}
                  label={key}
          ...
          {providerUrl && (
            ...
            >
              <QuestionCircleOutlined /> Having trouble configuring the model?{" "}
              <a
                href={providerUrl}
                target="_blank"
                rel="noreferrer"
