    ...
    <div className={styles.dashboardContent}>
      <div className={styles.dashboard}>
        ...
        <div className={styles.desc}>
          Your project has been deployed on TaskingAI serverless computing
          cluster, with vector storage and agent runtime all setup and ready to
          use.
        </div>
        <div className={styles.content}>
          <div className={styles["son-content"]}>
            <div className={styles["second-title"]}>Get started</div>
            <div className={styles.desc} style={{ marginBottom: "24px" }}>
              Embark on your AI-native adventure with TaskingAI, where Forums,
              API Reference, and Official Documentation are your treasure map to
              innovation.
            </div>
            <div className={styles["group-button"]}>
              <Button
                onClick={() => window.open("https://www.tasking.ai/examples")}
              ...
              <Button
                onClick={() => window.open("https://docs.tasking.ai")}
                style={{ display: "flex", alignItems: "center" }}
                icon={<Documentation />}
                className="cancel-button"
              >
              ...
              <Button
                onClick={() => window.open("https://forum.tasking.ai")}
                style={{ display: "flex", alignItems: "center" }}
                icon={<Forum />}
                className="cancel-button"
              >
        ...
        <div className={styles.desc} style={{ marginBottom: "24px" }}>
          Dive into the foundational trio of Model, Retrieval, and Tool with
          TaskingAI to build and integrate versatile, agent-driven applications.
          Seamlessly integrate with cloud resources or giants like OpenAI,
          Anthropic, and many else model providers, ensuring rapid incorporation
          into your project's code for immediate impact.
        </div>
        <div className={styles["card-group"]}>
          <div className={styles["card-item"]}>
            <div className={styles["card-top"]}>
              ...
              <div className={styles.desc}>
                Connect various LLM providers, granting a spectrum of advanced
                AI models to craft your application.
              </div>
            </div>
            <div className={styles["button-group"]}>
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/product_modules/model/overview",
                  )
                }
                icon={<ForwardIcon />}
                style={{ display: "flex", alignItems: "center" }}
          ...
          <div className={styles["card-item"]}>
            <div className={styles["card-top"]}>
              ...
              <div className={styles.desc}>
                Uses external data to enhance LLM inferences, enabling dynamic,
                context-aware interactions through record management and text
                queries.
              </div>
            </div>
            <div className={styles["button-group"]}>
              <Button
                className="cancel-button"
                onClick={() => handleNavigate("retrieval")}
              >
                Explore retrieval
              </Button>
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/product_modules/retrieval/overview/",
                  )
                }
                icon={<ForwardIcon />}
                style={{ display: "flex", alignItems: "center" }}
          ...
          <div className={styles["card-item"]}>
            <div className={styles["card-top"]}>
              ...
              <div className={styles.desc}>
                Featuring Plugins and Actions, enhances Assistant
                functionalities, enabling integration with external APIs and
                tailored function executions.
              </div>
            </div>
            <div className={styles["button-group"]}>
              <Button
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/product_modules/tool/overview/",
                  )
                }
                icon={<ForwardIcon />}
                style={{ display: "flex", alignItems: "center" }}
          ...
          <div className={styles["card-item"]}>
            <div className={styles["card-top"]}>
              ...
              <div className={styles.desc}>
                A flexible framework for building customizable AI agents,
                supporting diverse applications with integrated models, memory,
                retrieval, and tools.
              </div>
            </div>
            <div className={styles["button-group"]}>
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/product_modules/assistant/overview/",
                  )
                }
                icon={<ForwardIcon />}
                style={{ display: "flex", alignItems: "center" }}
        ...
        >
          <div className={styles["son-content"]}>
            ...
            <div className={styles.desc} style={{ marginBottom: "12px" }}>
              Interact with the project through the TaskingAI client SDKs with
              your API keys.
            </div>
            <div className={styles["group-button"]}>
              <Button
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/sdks/rest_api/authorization",
                  )
                }
                style={{ display: "flex", alignItems: "center" }}
                icon={<ForwardIcon />}
...
```'
        ...
        <div className={styles.desc} style={{ marginBottom: "24px" }}>
          Choose your preferred client library to start your project.
        </div>
        <div className={styles["card-bottom"]}>
          <div className={styles["card-bottom-item"]}>
            ...
            <div>
              <Button
                onClick={() => window.open("https://docs.tasking.ai/api/")}
                style={{ display: "flex", alignItems: "center" }}
                icon={<ForwardIcon />}
                className="cancel-button"
              >
          ...
          <div className={styles["card-bottom-item"]}>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <Button
                onClick={() =>
                  window.open("https://pypi.org/project/taskingai/")
                }
                className="cancel-button"
              >
                PyPI
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/sdks/python/quickstart",
                  )
                }
                style={{ display: "flex", alignItems: "center" }}
                icon={<ForwardIcon />}
          ...
          <div className={styles["card-bottom-item"]}>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <Button
                onClick={() =>
                  window.open(
                    "https://docs.tasking.ai/docs/guide/sdks/openai_compatible/overview",
                  )
                }
                style={{ display: "flex", alignItems: "center" }}
                icon={<ForwardIcon />}
