...
import {
  ...
  assistantListType,
  commonDataType,
} from "@/constant/assistant.ts";
import CommonComponents from "../../contents/index";
import { Button, Space, Drawer, Spin, Modal, Tooltip, Popover } from "antd";
function Assistant() {
  ...
  const [assistantPlaygroundIdParams, setAssistantPlaygroundIdParams] =
    useState("");
    ...
    <div className={styles["assistants"]}>
      <Spin spinning={loading} wrapperClassName={styles.spinloading}>
        <ModalTable
          ...
          hasMore={assistantHasMore}
          id="assistant_id"
          ifSelect={false}
          columns={columns}
          name="assistant"
          dataSource={assistantsList}
      ...
      >
        <ModalTable
          ...
          defaultSelectedRowKeys={selectedModelRows}
      ...
      <DeleteModal
        ...
        describe={`${t("deleteItem")} ${deleteValue || "Untitled Assistant"}? This action cannot be undone and all integrations associated with the assistant will be affected.`}
        title="Delete Assistant"
        projectName={deleteValue || "Untitled Assistant"}
        onDeleteCancel={onDeleteCancel}
        onDeleteConfirm={onDeleteConfirm}
      />
      <Drawer
        zIndex={10001}
        className={styles["drawer-action"]}
        closeIcon={
          <img
            src={closeIcon}
            alt="closeIcon"
      ...
      <CreateCollection
        handleFetchData={() => fetchDataRetrievalData({ limit: 20 })}
