...
const CreatePlugin = forwardRef((props: any, ref) => {
  ...
  const getBundleList = async (params: object) => {
    ...
    const selectedItem: any =
      res.data.find((item: any) => item.registered === false) || [];
  ...
  return (
    <>
      <Modal
        ...
        title={
          openCreateModal2
            ? t("projectPluginCreate")
            : t("projectBundleSelection")
        }
        open={open}
      ...
      >
        {openCreateModal2 ? (
          ...
          <div className={styles.modalContent}>
            <div className={styles.left}>
              <div className={styles.selectBundleDesc}>
                {t("projectBundleDesc")}
              </div>
              <div className={styles["content-modal"]}>
                <div className={styles.content}>
                  {bundilesList.map((item: any, index: number) => (
                    <div
                      key={index}
                      className={`${styles.frameParent} ${item.bundle_id === bundleId && styles.activeframeParent} ${item.registered && styles.registeredItem}`}
                      onClick={
                        item.registered
                          ? undefined
                          : () => {
                    ...
                    >
                      <div className={styles.logoParent}>
                        <img
                          src={(cachedImages as any)[item.bundle_id]}
                          alt=""
                      ...
                      <div className={styles.frameGroup}>
                        ...
                        <div className={styles.taskingaiWrapper}>
                          <div className={styles.taskingai}>
                            {item.developer}
                          </div>
                        </div>
                      </div>
      ...
      <Modal
        ...
        title={t("projectPluginCreate")}
        className={styles.createModal3}
      >
