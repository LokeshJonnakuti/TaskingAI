...
function CommonComponents() {
  ...
  const modelsTableColumn: any = [
    {
      ...
      render: (text: string, record: any) => (
        <div>
          ...
          >
            <span
              style={{ fontSize: "12px", color: "#777", lineHeight: "18px" }}
            >
              {record.model_id}
            </span>
            <CopyOutlined
              className="icon-copy"
              onClick={() => handleCopy(record.model_id)}
            />
          </p>
        </div>
      ),
    },
    {
      ...
      render: (text: string, record: any) => (
        <div className="img-text">
          <IconComponent providerId={record.provider_id} />{" "}
    ...
    },
    {
      ...
      key: "properties",
      width: 360,
      render: (properties: object) => <ModelIcon properties={properties} />,
    },
    {
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div style={{ marginLeft: "12px" }}>
            ...
            >
              ...
              <CopyOutlined
                className="icon-copy"
                onClick={() => handleCopy(record.bundle_id)}
              />
            </p>
          </div>
        </div>
      ...
      render: (plugins: any) => (
        ...
        >
          {plugins.map((plugin: any, index: any) => (
            ...
            >
              <span
                style={{ color: "#8F8F8F", fontWeight: 500, fontSize: "12px" }}
              >
                {plugin.name}
              </span>
            </div>
      ...
      render: (text: string, record: any) => (
        <div>
          ...
          >
            ...
            <CopyOutlined
              className="icon-copy"
              onClick={() => handleCopy(record.collection_id)}
            />
          </p>
        </div>
      ),
      ...
      render: (text: string, record: any) => (
        <div>
          ...
          >
            ...
            <CopyOutlined
              className="icon-copy"
              onClick={() => handleCopy(record.embedding_model_id)}
            />
          </p>
        </div>
      ),
      ...
      render: (text: string, record: any) => (
        <div>
          ...
          <p style={{ display: "flex", alignItems: "center", margin: 0 }}>
            ...
            <CopyOutlined
              className="icon-copy"
              onClick={() => handleCopy(record.action_id)}
            />
          </p>
        </div>
      ),
      ...
      render: (apikey: string) => (
        <>
          <div style={{ display: "flex", alignItems: "center", margin: 0 }}>
            <span style={{ fontSize: "12px", color: "#777" }}>{apikey}</span>{" "}
            {!apikey?.includes("****") && (
              <CopyOutlined
                className="icon-copy"
  ...
  const assistantTableColumn: any = [
      ...
      render: (text: string, record: any) => (
        <div>
          ...
          >
            ...
            <CopyOutlined
              className="icon-copy"
              onClick={() => handleCopy(record.assistant_id)}
            />
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      width: 180,
      dataIndex: "memory",
      render: (_: any) => <div>{reverseLabel[_]}</div>,
    },
    {
      title: `${t("projectModelColumnCreatedAt")}`,
      width: 180,
  ...
  const memberTableColumn: any = [
    ...
    },
    {
      ...
      render: (text: string) => (
        <Tag
          color={
            statusReverse[text as keyof typeof statusReverse] || "defaultColor"
          }
        >
          {text}
        </Tag>
