...
export const fetchAssistantsData = () => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/ui/assistants?limit=20`)
      .then((response) => {
...
export const fetchModelsData = (limit: number) => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/models?limit=${limit}`)
      .then((response) => {
...
export const fetchApikeysData = (limit: number) => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/apikeys?limit=${limit}`)
      .then((response) => {
...
export const fetchRetrievalData = (params: any) => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/ui/collections?${str}`)
      .then((response) => {
...
export const fetchPluginData = (limit: number) => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/bundle_instances?limit=${limit}`)
      .then((response) => {
...
export const fetchActionData = (limit: number) => {
  return (dispatch: any) => {
    ...
    request
      .get(`${project_base_url}/actions?limit=${limit}`)
      .then((response) => {
